...
**A simple, clean, and responsive theme [Jekyll](https://jekyllrb.com/) theme for academics.**
...
Academics aroundd the world use this theme for their homepages, blogs, lab pages, as well as webpages for courses, workshops, conferences, meetups, and more.
